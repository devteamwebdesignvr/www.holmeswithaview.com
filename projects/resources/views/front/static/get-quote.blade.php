				...
				<div class="trip">
					...
					<div class="trip-date">
						...
						<div class="date-box">
							...
							<form  action="{{ url('reserve') }}" method="get" class="loader-show-data">
					...
					<div class="trip-guest">
						...
						<div class="guest-box">
							<button type="button" class="btn-close"></button>
							<form method="get" action="{{ url('reserve') }}" class="loader-show-data">
								...
								<div class="prc fees">
										...
										<div class="discount-price-box">
											...
											@for($i=0;$i<$total_night;$i++)
												...
												<div>
													...
													<p class="amt">{{$sign}} {{number_format($c->price,2)}}</p>
												</div>
												@endforeach
											@endfor
											</div>
					             ...
					             @foreach($show_data_amount as $key=>$c)
                                    ...
                                    @endphp
								            ...
								            <div class="prc fees">
            									<div class="fees-value">
            										<p class="value"><span class="val">{{ $fee_name }}</span> 
