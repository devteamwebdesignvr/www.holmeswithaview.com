...
@section("container")
    ...
    //dd($main_data);
        ...
        //dd($listing_id,$start_date,$end_date,$amount,$name,$email,$adult,$child,$mobile);
        //HostAwayAPI::createbooking($listing_id,$start_date,$end_date,$amount,$name,$email,$adult,$child,$mobile);
        
        //dd($main_data,$property);
    @endphp
				...
				<div class="stick">
					<div class="sticky-area">
						...
						<div class="price-details">
							<p class="p-detail">Payment will be charged when you book this room, please review the <a href="{{ url('cancellation-policy') }}" target="_BLANK">Cancellation Policy</a> and important information before booking.</p>
							<div class="price-area">
							
								<div class="prc fees">
									<div class="fees-value">
										<p class="value"><span class="val">Base Price</span></p>
