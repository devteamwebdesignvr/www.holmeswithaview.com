...
<div class="row">
    <div class="col-md-6">
        <span style="font-size:13px;">{!! $setting_data['payment_currency'] !!} {{ number_format($base_price/$total_night,2)  }} x {{ $total_night }} nights</span>
    </div>
    <div class="col-md-6">
       {!! $setting_data['payment_currency'] !!}  {{number_format($base_price,2)}}
    </div>
</div>
        ...
        @if($c['isIncludedInTotalPrice']==1)
            @if($c['name']!="baseRate")
				   ...
				   <div class="row">
                        ...
                        <div class="col-md-6">
                           {!! $setting_data['payment_currency'] !!} {{number_format($c['total'],2)}}
                        </div>
                    </div>
             @endif
       @endif
   @endforeach
				   ...
				   <div class="row">
                        ...
                        <div class="col-md-6">
                           {!! $setting_data['payment_currency'] !!} {{number_format($main_data['data']['totalPrice'],2)}}
                        </div>
                    </div>
