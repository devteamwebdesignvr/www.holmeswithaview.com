		...
		<div class="row quote-area">
			<div class="col-6 quote-detail">
				...
				<div class="trip">
					...
					<div class="trip-date">
						...
						<div class="date-box">
							...
							<form  action="<?php echo e(url('reserve')); ?>" method="get" class="loader-show-data">
					...
					<div class="trip-guest">
						...
						<div class="guest-box">
							<button type="button" class="btn-close"></button>
							<form method="get" action="<?php echo e(url('reserve')); ?>" class="loader-show-data">
				...
				<form 
                    ...
                    <input type="hidden" name="gross_amount" value="<?php echo e($main_data['data']['totalPrice']); ?>"  />
				...
				<div class="stick">
					<div class="sticky-area">
						<div class="quote-pro">
        					...
        					<?php if($image): ?>
							<div class="pro-img">
								<img src="<?php echo e(asset($image)); ?>" class="img-fluid" alt="<?php echo e($property->title); ?>" title="<?php echo e($property->title); ?>" />
							</div>
							<?php endif; ?>
							<div class="pro-cont">
								<p class="home-type"><?php echo e($total_night); ?> NIGHTS IN <?php echo e($property->internalListingName); ?></p>
								<h4 class="pro-name"><?php echo e($property->title); ?></h4>
							</div>
						</div>
								...
								<div class="prc fees">
										...
										<div class="discount-price-box">
											...
											<?php for($i=0;$i<$total_night;$i++): ?>
												...
												<div>
													...
													<p class="amt"><?php echo e($sign); ?> <?php echo e(number_format($c->price,2)); ?></p>
												</div>
												<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
											<?php endfor; ?>
											</div>
					             ...
					             <?php $__currentLoopData = $show_data_amount; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    ?>
								            ...
								            <div class="prc fees">
            									<div class="fees-value">
            										<p class="value"><span class="val"><?php echo e($fee_name); ?></span> 
...
?>
	$(document).ready(function() {
	  function formatOption(option) {
	    ...
	    var optionWithImage = $('<span><img src="' + option.flag + '" class="img-flag" /> '+option.text+' </span>');
...
$(document).on("submit",".loader-show-data",function(){
							               $("#sygnius-loader").removeClass("d-none");
							          });
</script>

<?php $__env->stopSection(); ?>
<?php echo $__env->make("front.layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/holmeswithaview/htdocs/www.holmeswithaview.com/projects/resources/views/front/static/get-quote.blade.php ENDPATH**/ ?>