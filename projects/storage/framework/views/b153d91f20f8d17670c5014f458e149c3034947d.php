...
<div class="row">
    <div class="col-md-12">
        <div class="form-group">
            <?php echo Form::label("evolve_link"); ?>

            <?php echo Form::textarea("evolve_link",null,["class"=>"form-control","rows"=>"2"]); ?>

            <span class="text-danger"><?php echo e($errors->first("evolve_link")); ?></span>
        </div>
    </div>
</div>
<div class="row">
...
<?php /**PATH /home/holmeswithaview/htdocs/www.holmeswithaview.com/projects/resources/views/admin/host_fully_properties/form.blade.php ENDPATH**/ ?>